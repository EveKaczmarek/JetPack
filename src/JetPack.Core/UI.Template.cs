...
namespace JetPack
{
	...
	{
		public partial class Template : MonoBehaviour
		{
			public ChaControl _chaCtrl
			{
				get
				{
					if (CharaStudio.Running)
						return CharaStudio.CurOCIChar?.charInfo;
					else
			...
			protected virtual void Awake()
			{
				...
				_windowBGtex = MakePlainTex((int) _windowSize.x, (int) _windowSize.y, _windowBG);
